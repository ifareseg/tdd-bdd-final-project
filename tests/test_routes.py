...
class TestProductRoutes(TestCase):
    ...
    def test_update_product(self):
        ...
        self.assertEqual(updated["id"], test_product.id)
        self.assertEqual(updated["name"], "Hat")
        self.assertEqual(updated["description"], "Updated Description")
        self.assertEqual(Decimal(updated["price"]), Decimal("99.99"))
        self.assertEqual(updated["available"], False)
        self.assertEqual(updated["category"], Category.CLOTHS.name)
    ...
    def test_query_product_by_category(self):
        ...
        test_product = ProductFactory()
        test_product.name = "Big Mac"
        test_product.description = "Burger"
        test_product.price = Decimal("10.99")
